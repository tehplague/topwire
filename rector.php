...
return RectorConfig::configure()
     ...
     */
    ->withRules([StringClassNameToClassConstantRector::class])

    // Optional non-php file functionalities:
    // @see https://github.com/sabbelasichon/typo3-rector/blob/main/docs/beyond_php_file_processors.md

    // Add some general TYPO3 rules
    ->withRules([ConvertImplicitVariablesToExplicitGlobalsRector::class])
    ->withRules([ExtEmConfRector::class])
    ...
    // ->withRules([FileIncludeToImportStatementTypoScriptRector::class])
    ;
